-- Update assign_ximatar_by_pillars to include Bee bonus logic
...
BEGIN
  ...
  ELSE
    ...
    LOOP
      ...
      -- Special bonus for Bee
      IF ximatar_rec.label = 'bee' AND drv_score >= 8.0 AND comm_score >= 6.0 AND crea_score <= 5.0 THEN
        current_distance := current_distance * 0.7;
      END IF;
