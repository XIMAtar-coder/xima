          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-muted/40 rounded-full flex items-center justify-center mx-auto mb-3 ring-1 ring-border/40">
                <img loading="lazy" decoding="async" src="/ximatars/owl.webp" alt="XIMAtar Owl" className="h-11 w-11 rounded-full object-cover" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-muted/40 rounded-full flex items-center justify-center mx-auto mb-3 ring-1 ring-border/40">
                <img loading="lazy" decoding="async" src="/ximatars/fox.webp" alt="XIMAtar Fox" className="h-11 w-11 rounded-full object-cover" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-muted/40 rounded-full flex items-center justify-center mx-auto mb-3 ring-1 ring-border/40">
                <img loading="lazy" decoding="async" src="/ximatars/wolf.webp" alt="XIMAtar Wolf" className="h-11 w-11 rounded-full object-cover" />
              </div>
