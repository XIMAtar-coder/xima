        ...
        {!revealedProfile ? (
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
              <img src={imgUrl} alt={archetypeName} width={40} height={40} loading="lazy" decoding="async" className="h-10 w-10 object-contain" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
              <div>
