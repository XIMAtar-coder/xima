...
const PILLAR_ICONS = [Brain, MessageCircle, BookOpen, Lightbulb, Zap];
    ...
    <MainLayout>
      <div className="container max-w-4xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <h1 className="text-[28px] md:text-[34px] xl:text-[40px] font-bold mb-4 whitespace-pre-line">
          ...
          <p className="italic text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
        ...
        <section className="mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((n) => {
              ...
              return (
                <Card key={n} className="p-6 text-center hover:shadow-lg transition-shadow group premium-card">
        ...
        <section className="mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {(['l1', 'l2', 'l3'] as const).map((level) => {
              ...
              return (
                <Card key={level} className="p-6 hover:shadow-lg transition-shadow glass-surface-static">
        ...
        <section className="mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 justify-items-center mb-6">
        ...
        {/* ── CTA ── */}
        <Card className="p-8 text-center glass-surface-static border-2 border-primary/20 mb-12">
          <h2 className="text-3xl font-bold mb-4 text-foreground whitespace-pre-line">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild size="lg" className="bg-primary hover:bg-primary/90 px-8 py-4">
